 export default  (dcl, Stateful) =>{
	...
	function doBidiReorder(/*String*/text, /*String*/inFormat,
				/*String*/outFormat, /*String*/swap, /*Object*/bdx) {   //jshint maxcomplexity: 15
		// summary:
	...
	function prepareReorderingParameters(/*String*/text, /*Object*/params, /*Object*/bdx) {   //jshint maxcomplexity: 15
		// summary:
	...
	function doShape(str06, Ix, step, nIEnd, compress) {   //jshint maxcomplexity: 15
		// summary:
		//		Shape the source text.
		// str06:
	...
	function computeLevels(chars, levels, bdx) {     //jshint maxcomplexity: 15
